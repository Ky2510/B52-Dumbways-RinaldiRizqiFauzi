...
// Abstraksi memungkinkan menyembunyikan informasi dan menampilkan yang dibutuhkan.
        ...
        return `
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-text" style="margin-right: auto;">${this.title}</h4>
                            <div class="description">
                                <p class="card-text" style="margin-right: auto; font-size: 14px;">${this.description}</p>
                            </div>
                            <div class="author">
                                ${this.author}
                            </div>
